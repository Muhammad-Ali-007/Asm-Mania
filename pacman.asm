;	Done By : Mohammad and Muhammad Ali 
.Model 	Small
.Stack 1000
.Data
;					Program Variables 							
...
; Strings To Be Displayed for the user
	...
	exitMsgLen dw 27
	doneByMsg db "Done By Mohammad and Muhammad Ali",1h,10,13,10,13,10,13,10,13,10,13,10,13,10,13,10,13,10,13,10,13,10,13,10,13,10,13
	doneByMsgLen dw 55
